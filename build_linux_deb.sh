...
Depends: python3 (>= 3.10), libusb-1.0-0, python3-fido2, python3-pyside6.qtcore, python3-pyside6.qtgui, python3-pyside6.qtwidgets, python3-qtawesome, python3-requests, python3-usb
